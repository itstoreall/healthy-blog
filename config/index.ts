...
export const globalConfig = {
  ...
  home: {
    ...
    meta: {
      title: blogTitle,
      description:
        "Вітаємо! Блог Хелсі - це статті про симптоми захворювань, пізнання організму та здоров’я свого та близьких людей. Блог Хелсі - це допомога своєчасно помітити та розібратися, що саме може загрожувати людині та членам сім’ї. Завдяки статтям медичного саморозвитку зможете попередити багато захворювань та вчасно звернутись до фахівців. В блозі ви знайдете поради про першу домедичну допомогу при різних захворюваннях, особливо коли симптоми з’являються вперше. Також в Хелсі ви дізнаєтесь правила догляду за хворими і навички середнього медичного персоналу.",
    },
    content: {
      title: "Хелсі - Блог медичного саморозвитку",
    },
  },
  articles: {
    pathname: "/articles",
